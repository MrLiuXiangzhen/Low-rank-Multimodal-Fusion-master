...
def main(options):
    ...
    with open(output_path, 'w+') as out:
        ...
        writer.writerow([ "video_hidden", 'text_hidden',  'video_dropout', 'text_dropout',
    ...
    for i in range(total_settings):
        ...
        current_setting = (  thid,  vdr, tdr, factor_lr, lr, r, batch_sz, decay)
        ...
        if complete:
            ...
            results = [ thid,  vdr, tdr, factor_lr, lr, r, batch_sz, decay, min_valid_loss.cpu().data.numpy()]
